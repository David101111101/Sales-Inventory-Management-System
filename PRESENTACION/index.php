<?php session_start();
$_SESSION['usuario']=$_REQUEST["TXTusuario"];
?>
<?
...
$confirm=$_REQUEST["confirmar"];
       if ($confirm == 'si')
    {
	       if ($usuario == "" ||$clave == ""  )
        {
            ...
            $msgErr="debe ingresar un <u>USUARIO</u> y una <u>CLAVE</u>";
        }
        else
        {
...
if ($row["passUSU"]!=$clave){
                     ...
                     $msgErr="Usuario o clave incorrectas ";
					  		   
							            }
		            else{
					
					           if ($row["estadoUSU"]!="ACTIVO"){
							   $msgErr="<BR>El Usuario se encuentra ELIMINADO (INACTIVO) contactese con el ADMINISTRADOR ";
						...
						<div class="wrapper">
								...
								<div class="box first">
									<div class="pad">
										...
										<strong class="numb img-indent2">01</strong>
										        <form name="inicioSesion" method="post" >
												
															<div class="extra-wrap"><br>
												           <h3 class="color-1"><strong>Ingresa al</strong> sistema</h3>
											         </div>
													 ...
													 <?php echo $msgOk;?></b>	
										                ...
										                <div class="wrapper">
											                	 ...
											                	 <b style="color: red" size=80>	<?php echo $msgErr;?></b>	
															      <input type="submit" class="button img-indent-r" />
														    usuario
												             <td><input type="text" name="TXTusuario" id="TXTusuario" autocomplete="off" ></td>
															  contraseña
												             <td><input type="password" name="TXTcontra" id="TXTcontra" autocomplete="off"/></td><br>
															 
															 	
																		 <A HREF="nuevoUSU.php">REGISTRESE</A><br>
																         <A HREF="OLVIDOSUCLAVE.php">OLVIDO SU CLAVE?</A>
							...
							<div class="col-1">
								<div class="box second">
									<div class="pad">
										<div class="wrapper indent-bot">
											<strong class="numb img-indent2">02</strong><br>
											<div class="extra-wrap">
												<h3 class="color-2"><strong>Seleccione </strong>Producto</h3>
											</div>
										</div>
										<div class="wrapper">
											<a class="button img-indent-r" onmouseover="MSSGselectProduct()"></a>
											<div class="extra-wrap">
							...
							<div class="col-2">
								<div class="box third">
									<div class="pad">
										<div class="wrapper indent-bot" disabled="disabled">
											<strong class="numb img-indent2">03</strong><br>
											<div class="extra-wrap">
												<h3 class="color-3"><strong>generar</strong>pedido</h3>
											</div>
										</div>
										<div class="wrapper" disabled="disabled">
											<a class="button img-indent-r" onmouseover="MSSGpedidoVent()" ></a>
											<div class="extra-wrap">
							...
							<div class="block-news">
								...
								<div class="wrapper p2">
									...
									<div class="extra-wrap">
										...
										bandeja blanca con un costo de $100 la unidad de primera calidad <a href="productos.php">MAS</a>
									</div>
								</div>
								<div class="wrapper">
									...
									<div class="extra-wrap">
										<h5>bandeja griz</h5> 
										bandeja gris con un costo de $50 de segunda calidad <a href="productos.php">MAS</a>
									</div>
								</div>
							</div>
						</div>
...
<script>
function MSSGpedidoVent () 
{
alert("DEBES INICIAR SECION PARA GENERAR UNA COMPRA")
	 return false;
	 }
	 
	 
	 function MSSGselectProduct () 
{
alert("DEBES INICIAR SECION PARA SELECCIONAR UN PRODUCTO")
	 return false;
	 }
