	...
	<div class="bg">
		<div class="main">
			<header>
				<div class="row-1">
					<h1>
					<strong >Recuperadora</strong><br>
						<strong class="footer-logo">REX<font color="green">AR</font></strong>S.A.S
								...
								<div class="box first">
									<div class="pad">
										<div class="wrapper indent-bot">
										        <form name="inicioSecion" method="post" action="../NEGOCIO/inicioSecion.php"  >
													 ...
													 <?php echo $msgOk;?></b>	
										                ...
										                <div class="wrapper">
											              ...
											              <a name="ingreso" type="submit" class="button img-indent-r" ONCLICK="validar()">>></a>
														    usuario
															 ...
															 <input type="hidden" name="confirmar" value="si"/>
																		 ...
																		 <A HREF="nuevoUSU.php">REGISTRESE</A>
							...
							<div class="col-1">
								<div class="box second">
									<div class="pad">
										...
										<div class="wrapper">
											<a href="productos.php" class="button img-indent-r" href="#"></a>
											<div class="extra-wrap">
...
contraseña= document.getElementById("TXTcontra").value; 
...
document.forms.inicioSecion.submit() 
