...
if ($confirmar == "si")
{
 ...
 $NOMusu=$_REQUEST['txtcodigo'];  


$sql="UPDATE usuarios SET estadoUSU='INACTIVO' WHERE nomUSU='$NOMusu' ";

$res=mysql_query($sql);
$msgOk="EL usuario paso de ser ACTIVO a INACTIVO exitosamente";

}
$nom=$_REQUEST['NOMBRE1'];


$sql="SELECT * FROM usuarios WHERE nomUSU='".$nom."'";
$res=mysql_query($sql);
...
<CENTER>
<HR>
<font style="color: red"><strong>INGRESE EL NOMBRE DE USUARIO A ELIMINAR  </font><BR></strong>	
<td><input type="text" name="txtcodigo"  id="txtcodigo"value='<?php echo $registro['nomUSU'];?>' /></td>
</tr>
<HR>
